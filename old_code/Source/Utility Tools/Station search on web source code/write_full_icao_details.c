 ...
 *
 * $Revision: 1$
 * $Date: 31/08/2006 16:09:05$
 * $Source: /home/us0400/usmdb/station_search/source/RCS/write_full_icao_details.c,v $
 *
 * $Log:
 *  1    Met_DB_Project 1.0         31/08/2006 16:09:05    Stan Kellett    
 * $
 * Revision 1.3  2006/08/29 08:18:04  usmdb
 * changed mdb folder to mdb_new folder
 *
 * Revision 1.2  2002/12/19 13:18:40  usmdb
 * corrected the reading in of the station nuber from chars 2 to 6 , to 1 to 5.
 *
 * Revision 1.1  2000/06/08 15:58:35  usmdb
 * Initial revision
 *
 *
 */
...
int write_full_icao_details(char *icao)
	{
/* Declare and initialise variables */
 ...
 char details[BUFLEN];
 char check;
 char full_stnmas[]="/home/us0400/mdb_new/op/data/MDB.STNMAS.FULLLST";
/* Allocate Memory */
...
/* Now set each element of Station Details for printing to Web page */
	   ...
	   region=part_string(details,region,115,116);
           station_num=part_string(details,station_num,1,5); // !1.2
