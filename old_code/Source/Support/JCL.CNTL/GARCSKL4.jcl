//MDBDBGAV JOB (OP1,DB,WDS0BF),METDB,CLASS=J,USER=T12DB,
//  MSGCLASS=Q
//*
//*---------------------------------------------------------------------
//* Archive GRIB data sets into MASS-R  (datatype RADRF)
//*
//* Job generated from skeleton JCL MDB.JCL.CNTL(GARCSKEL4)
//* and submitted by MDB.JCL.CNTL(GARCSUB)
//*---------------------------------------------------------------------
//* $Workfile: GARCSKL4.jcl$ $Folder: JCL.CNTL$
...
//SYSIN   DD DSN=MDB.GRIBARC.SCRATCH4,DISP=SHR                     !ST2
// ENDIF
//
