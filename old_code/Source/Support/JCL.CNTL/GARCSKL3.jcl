//MDBDBGAU JOB (OP1,DB,WDS0BF),METDB,CLASS=J,USER=T12DB,
//  MSGCLASS=Q
//*
//*---------------------------------------------------------------------
//* Archive GRIB data sets into MASS-R  (datatype RADOP2)
//*
//* Job generated from skeleton JCL MDB.JCL.CNTL(GARCSKEL3)
//* and submitted by MDB.JCL.CNTL(GARCSUB)
//*---------------------------------------------------------------------
//* $Workfile: GARCSKL3.jcl$ $Folder: JCL.CNTL$
...
//SYSIN   DD DSN=MDB.GRIBARC.SCRATCH3,DISP=SHR                     !ST2
// ENDIF
//
