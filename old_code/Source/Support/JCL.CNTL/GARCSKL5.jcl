//MDBDBGAX JOB (OP1,DB,WDS0BF),METDB,CLASS=J,USER=T12DB,
//  MSGCLASS=Q
//*
//*---------------------------------------------------------------------
//* Archive GRIB data sets into MASS-R  (datatype DRWIND)
//*
//* Job generated from skeleton JCL MDB.JCL.CNTL(GARCSKEL5)
//* and submitted by MDB.JCL.CNTL(GARCSUB)
//*---------------------------------------------------------------------
//* $Workfile: GARCSKL5.jcl$ $Folder: JCL.CNTL$
...
//SYSIN   DD DSN=MDB.GRIBARC.SCRATCH5,DISP=SHR                     !ST2
// ENDIF
//
