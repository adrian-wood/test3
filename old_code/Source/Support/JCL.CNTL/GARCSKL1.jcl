...
//*
//*---------------------------------------------------------------------
//* Archive GRIB data sets into MASS-R  (STANDARD datatypes )
//*
//* Job generated from skeleton JCL MDB.JCL.CNTL(GARCSKEL1)
//* and submitted by MDB.JCL.CNTL(GARCSUB)
//*---------------------------------------------------------------------
//* $Workfile: GARCSKL1.jcl$ $Folder: JCL.CNTL$
...
//SYSIN   DD DSN=MDB.GRIBARC.SCRATCH1,DISP=SHR                     !ST2
// ENDIF
//
