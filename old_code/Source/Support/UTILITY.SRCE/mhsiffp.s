...
* ---------------------------------------------------------------------
*  This is a modification of version 3.0 of MHSIFF from MHS.FTP.SRCE.
* It has been changed to look for data sets starting MHSP rather than
* MHSR and the 'rename' option is now a dummy call which does nothing.
* It does not need to be run from an 'authorised' library.
* ---------------------------------------------------------------------
*
...
*
         ...
         BAL      R14,FSAMER                AMS error to process
         LTR      R15,R15
...
FILLER4  DC       CL28'  '
HLQMHSR  DC       CL04'MHSP'          HLQ of received files
