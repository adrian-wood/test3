...
! REVISION INFO :
!
! $Workfile: synret.f$ $Folder: pre_refresh$
! $Revision: 4$ $Date: 30/07/2008 09:05:24$
!
! Change record :
!
! $Log:
!  4    Met_DB_Project 1.3         30/07/2008 09:05:24    Brian Barwell   Force
!        MAPRD to look for local BUFR sequence when reading the map record.
!  3    Met_DB_Project 1.2         16/08/2007 14:38:20    Brian Barwell
!       Delete premature exit from 'DO 81' loop after first index match for
!       single-station retrievals.
!  2    Met_DB_Project 1.1         25/04/2006 15:42:55    Brian Barwell   Sort
!       by record number if 'ORDER NONE' is specified.
!  1    Met_DB_Project 1.0         30/01/2006 20:24:58    Sheila Needham  
! $
!
