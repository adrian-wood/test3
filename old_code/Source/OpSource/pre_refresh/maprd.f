...
!
! $Revision: 2$
! $Date: 30/07/2008 09:10:45$
! $Source: /home/us0400/mdb/op/lib/source/RCS/maprd.f,v $
!
! CHANGE RECORD :
!
! $Log:
!  2    Met_DB_Project 1.1         30/07/2008 09:10:45    Brian Barwell   New
!       option 'MAPR1' for last argument - like 'MAPRD' but always looks for
!       BUFR sequence indicator after map.
!  1    Met_DB_Project 1.0         30/01/2006 20:23:07    Sheila Needham  
! $
...
!-----------------------------------------------------------------------
      ...
      CHARACTER*80       HEAD                                        !2
      HEAD = '$Workfile: maprd.f$ ' //
     &       '$Revision: 2$ $Date: 30/07/2008 09:10:45$ '
