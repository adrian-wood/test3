...
! REVISION INFO :
!
! $Workfile: bufdrpl.f$ $Folder: pre_refresh$
! $Revision: 2$ $Date: 18/01/2007 15:05:46$
!
! CHANGE RECORD :
!
! $Log:
!  2    Met_DB_Project 1.1         18/01/2007 15:05:46    Brian Barwell
!       Ensure nested replication descriptors get deleted when outer
!       replication count is zero.
!  1    Met_DB_Project 1.0         30/01/2006 20:21:15    Sheila Needham  
! $
!
!-----------------------------------------------------------------------
