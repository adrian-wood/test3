...
! revision info :
!
! $Workfile: msgsub.f$ $Folder: pre_refresh$
! $Revision: 2$ $Date: 24/07/2007 11:19:25$
!
! change record :
!
! $Log:
!  2    Met_DB_Project 1.1         24/07/2007 11:19:25    Brian Barwell
!       Increment segment start positions if replication count is preserved by
!        BUFR decode.
!  1    Met_DB_Project 1.0         30/01/2006 20:23:28    Sheila Needham  
! $
