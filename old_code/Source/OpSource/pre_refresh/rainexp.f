...
! CALLS         : NONE                                                 
!                                                                      
! PARAMETERS    : (1) REPORT       (CHARACTER DATA PASSED TO FUNCTION) 
...
!
! $Revision: 1$
! $Date: 30/01/2006 20:23:55$
! $Source: /home/us0400/mdb/op/lib/source/RCS/rainexp.F,v $
!                                                      
! CHANGE RECORD :
!                                                                      
! $Log:
!  1    Met_DB_Project 1.0         30/01/2006 20:23:55    Sheila Needham  
! $
...
! Declare variables                                                     
      ...
      CHARACTER*(*)  REPORT         ! Character data.                   
      ...
      HEAD='
     &$Source: /home/us0400/mdb/op/lib/source/RCS/rainexp.F,v $
     &'//'$ $Revision: 1$ $Date: 30/01/2006 20:23:55$ '
...
! If no trace amount, convert the value to a real number.           !2.0
      ...
      IF (CHECK) THEN                                                   
        IF (REPORT(1:4).EQ.'9999') THEN                             !2.0
          RAINEXP = -1.0                                            !2.0
        ELSE                                                        !2.0
