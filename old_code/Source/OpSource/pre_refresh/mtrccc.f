...
!
! $Revision: 2$
! $Date: 01/06/2010 13:58:55$
! $Source: /home/us0400/mdb/op/lib/source/RCS/mtrccc.F,v $
!
! CHANGE RECORD :
!
! $Log:
!  2    Met_DB_Project 1.1         01/06/2010 13:58:55    Richard Weedon
!       Changes made to recognise NDV,NCD and NSC in VIS and cloud groups. 
...
! Initialise variables
      ...
      HEAD='
     &$Source: /home/us0400/mdb/op/lib/source/RCS/mtrccc.F,v $
     &'//'$ $Date: 01/06/2010 13:58:55$ $Revision: 2$'
...
!  get cloud amount: note n values are maximum of poss range.
      ...
      IF (CHARR(1:3) .EQ. 'YYY') THEN
        ...
        ELSEIF (REPORT(POINT:POINT+2) .EQ. 'FEW') THEN
          CLDAMT=13
        ELSEIF (REPORT(POINT:POINT+2) .EQ. 'NSC') THEN          !2.0
          CLDAMT=0                                              !2.0
        ELSEIF (REPORT(POINT:POINT+2) .EQ. 'NCD') THEN          !2.0
          CLDAMT=0                                              !2.0
        ENDIF
