...
! REVISION INFO :
!
! $Workfile: msgsubn.f$ $Folder: pre_refresh$
! $Revision: 2$ $Date: 18/01/2007 15:07:18$
!
! CHANGE RECORD :
!
! $Log:
!  2    Met_DB_Project 1.1         18/01/2007 15:07:18    Brian Barwell
!       Delete nested sub-segments from segment table arrays if outer
!       replication count is zero.
!  1    Met_DB_Project 1.0         30/01/2006 20:23:29    Sheila Needham  
! $
