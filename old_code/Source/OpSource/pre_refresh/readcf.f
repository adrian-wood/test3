...
!
! $Revision: 1$
! $Date: 30/01/2006 20:23:58$
! $Source: /home/us0400/mdb/op/lib/source/RCS/readcf.f,v $
!
! CHANGE RECORD :
!
! $Log:
!  1    Met_DB_Project 1.0         30/01/2006 20:23:58    Sheila Needham  
! $
...
! e or not.
!
c Revision 2.1  2003/09/04  14:08:41  14:08:41  usmdb (MetDB account c/o usjh)
c 15 Sept 2003    C Long
c 2.1  Correct 2 silly mistakes in code to index backward references.
c
c Revision 2.0  2003/03/06  09:24:39  09:24:39  usmdb (MetDB account c/o usjh)
c *** empty log message ***
c
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
     ...
     &     '$Revision: 1$ $Date: 30/01/2006 20:23:58$'
