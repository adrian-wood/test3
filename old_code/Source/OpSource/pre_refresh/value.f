...
!
! $Revision: 5$
! $Date: 03/08/2006 12:07:44$
! $Source: /data/us0400/mdb/op/lib/source/RCS/value.F,v $
!
! CHANGE RECORD :
!
! $Log:
!  5    Met_DB_Project 1.4         03/08/2006 12:07:44    Alison Weir
!       Heading correction
!  4    Met_DB_Project 1.3         03/08/2006 11:59:44    Alison Weir
!       StarTeam heading info corrected.
!  3    Met_DB_Project 1.2         03/08/2006 11:46:15    Alison Weir
!       Updated with GPCS version which had had an additional change made in
!       2002 - this change included the change made to version 2(ST).
!  2    Met_DB_Project 1.1         06/07/2006 12:54:23    Alison Weir     HEAD
!       changed from Character*1 to *132
...
!-----------------------------------------------------------------------
      ...
      IF (.NOT.HEADSET) THEN                                        !1.2
        HEAD='$Workfile: value.f$ ' //
     &       '$Revision: 5$ $Date: 03/08/2006 12:07:44$'
        HEADSET=.TRUE.                                              !1.2
      ENDIF                                                         !1.2
