SUBROUTINE WEBNCM(CREP,RPRTEND,WRITEHEADER,TOR,CREP2,IN_TEXT)
...
!
! purpose       : To format NCM raw reports for web retrieval.
!
! description   : The NCM raw report (including header) is passed
...
! REVISION INFO:
!
! $Workfile: webncm.f90$ $Folder: OpSource$
...
CALL WEBGEXP(CREP,CREP2,RPRTEND,' 666 ')
CALL WEBGEXP(CREP,CREP2,RPRTEND,' 888 ')
