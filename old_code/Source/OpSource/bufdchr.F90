...
! REVISION INFO :
!
! $Workfile: bufdchr.F90$ $Folder: OpSource$
...
INTEGER               :: I
INTEGER,INTENT(INOUT) :: IBEFOR ! argument (7)
INTEGER,INTENT(INOUT) :: INAM   ! argument (10)
INTEGER,INTENT(OUT)   :: IRC    ! argument (12)
INTEGER,INTENT(INOUT) :: IVAL   ! argument (9)
...
! INTEGER              :: VALUE  !function to get octets from data sect
INTEGER,INTENT(IN)    :: WIDTH  ! argument (4)

LOGICAL,INTENT(IN)    :: CMPRES ! argument (3)
LOGICAL,INTENT(IN)    :: DSPLAY ! argument (5)

CHARACTER(LEN=60),INTENT(IN) ::  NAME   ! argument (6)
CHARACTER(LEN=*),INTENT(OUT) ::  NAMES  ! argument (11)
CHARACTER(LEN=*),INTENT(IN)  ::  STRING ! argument (1)

REAL,INTENT(INOUT)           ::  VALUES(*) ! argument (8)
