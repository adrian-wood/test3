     ...
     &       ACCESS='DIRECT',RECL=LRECL)
        ...
        ELSE IF (IORC.EQ.0) THEN                                    !1.5
          ...
          IF (IORC.EQ.0) THEN                                       !1.8
            IREC=IREC+1
            READ (IFT,REC=IREC,IOSTAT=IORC) CS3(1:LRECL)                     !1.8
          ENDIF                                                     !1.8
        ENDIF                                                       !1.5
        CALL EB2ASC(4,BUFR)
