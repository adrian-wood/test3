/*--------------------------------------------------------------------*
 * Program        : ssrpc_HP.c - HP version. Subroutine name = tmdbp_1
 *
 * Language       : C
 ...
 * $Source: /home/us0400/mdb/op/lib/RPC/server/main/RCS/ssrpc_HP.c,v $
 *
 * Change history :
 *
 * $Log:
 ...
 * $
 * Revision 1.1  2001/01/09  14:14:38  14:14:38  usmdb (Generic MDB account)
 * Initial revision
 * 
 *
 * 04-01-2001   Adapted from IBM version ssrpc_IBM.c v1.3 - S.Cox
 *--------------------------------------------------------------------*/
...
#ifdef DEBUG
  (void)fprintf(stdout,"tmdbp_1: About to call mdb\n");
#endif /* DEBUG */
...
#ifdef DEBUG
  (void)fprintf(stdout,"tmdbp_1: Back from mdb\n");
#endif /* DEBUG */
