 ...
 *
 * $Revision: 1$
 * $Date: 09/11/2009 12:42:45$
 * $Source: /home/us0400/mdb/op/lib/RPC/server/broker/RCS/mdb_rpc_broker.c,v $
 *
 * Changes      :
 *
 * $Log:
 *  1    Met_DB_Project 1.0         09/11/2009 12:42:45    Sheila Needham
 *       Copied to mdb_rpc_broker.c as part of build
 * $
...
/* ------------------------------------------------------------------
   ...
   sprintf(rqsttxt,"%s/mdb_start_server %d",DIR,prognum);
   rc = system(rqsttxt);
...
/* ------------------------------------------------------------------
   ...
   sprintf(rqsttxt,"%s/mdb_check_server %d %s",DIR,prognum,
