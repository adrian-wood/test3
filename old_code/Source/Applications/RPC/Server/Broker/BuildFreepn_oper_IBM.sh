...
# --------------------------------------------------------------------
# Script to build The freepn_oper MetDB RPC freepn server.
# --------------------------------------------------------------------
...
cc -o $EXECDIR/freepn_oper *.c /usr/lpp/tcpip/rpc/lib/librpclib.a
...
echo "\nfreepn_oper built\n"
echo "You should now move it to /usr/local/mdb/oper/bin\n"
exit
