...
# --------------------------------------------------------------------
# Script to build The broker MetDB RPC broker server
# --------------------------------------------------------------------
...
# increase the number of servers available from 50 to 80

BASE_PROGNUM=200020
PROGNUM_COUNT=80
BROKER_PROGNUM=0x2000880
...
cc -o $EXECDIR/broker *.c /usr/lpp/tcpip/rpc/lib/librpclib.a
#cc -o $EXECDIR/broker *.c -l rpclib
