...
! Revision Info:                                                      !
! $Revision: 1$                                                        !
! $Date: 11/10/2006 11:56:54$
! $Source: /data/us0400/mdb/op/lib/source/RCS/crexdat.f,v $
!                                                                     !
! CHANGE RECORD:                                                      !
! $Log:
!  1    Met_DB_Project 1.0         11/10/2006 11:56:54    Kudsia Gwangwaa 
! $
...
!                            (but see CREXVAL for precise description!)
      ...
      CHARACTER*24 FORMO(6)    ! format statements (see below)      !1.2
...
! after the decimal point.  Each is to print name, units & value.
     ...
     &           '(1X,A47,A10,F11.5)','(1X,A47,A10,1P,E11.4)'/      !1.2
      ...
      IF (.NOT. HEADSET) THEN
        HEAD='$RCSfile: $ '//
     &   '$Revision: 1$ $Date: 11/10/2006 11:56:54$ '
        HEADSET = .TRUE.
      ENDIF
...
! Express descriptor as F,X,Y (packed as F*16384+X*256+Y in CREX)
...
! If scale>0, print that many figures after the decimal point.
              ...
              ELSE
                ...
                ELSE IF (SCALE.GT.0) THEN
                  I=MIN0(SCALE,6)                                   !1.2
                  WRITE (*,FORMO(I)) NAME,UNITS,V                   !1.2
                ENDIF
              ENDIF
            ENDIF
          ENDIF
...
! This should leave only element descriptors.
