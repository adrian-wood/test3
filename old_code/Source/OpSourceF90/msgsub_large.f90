...
!#######################################################################
!##     MODIFIED VERSION FOR TESTING STORAGE OF LARGE BULLETINS.     ###
!#######################################################################
!-----------------------------------------------------------------------
!
...
! REVISION INFO :
!
! $Workfile: msgsub_large.f90$ $Folder: OpSourceF90$
...
!#######################################################################
!OLD  INTEGER IRDES(18000)   ! Descriptor array from BUFR decode
INTEGER IRDES(60000)   ! Descriptor array from BUFR decode     !#
!#######################################################################
...
IF (FIRST) THEN
  HEAD = '$Workfile: msgsub_large.f90$ ' //&
        &'$Revision: 1$ $Date: 12/02/2010 14:41:52$'
  FIRST = .FALSE.
END IF
