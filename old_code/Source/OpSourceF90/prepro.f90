PROGRAM PREPRO !(String inFile, String outFile)
...
! REVISION INFO :
!
! $Workfile: prepro.f90$ $Folder: OpSourceF90$
! $Revision: 1$ $Date: 04/11/2009 15:54:14$
!
! CHANGE RECORD :
!
! $Log:
!  1    Met_DB_Project 1.0         04/11/2009 15:54:14    Stan Kellett
!       versions converted from f77 to f90 to run on UNIX services
! $
!-----------------------------------------------------------------------
