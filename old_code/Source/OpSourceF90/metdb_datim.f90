!-----------------------------------------------------------------------
!
! Routine       : metdb_datim.f90 subroutine.
!
! Description   : fortran 90 version of ibm datim - program to get the
